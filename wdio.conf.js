// import {CloseFlyer} from "./src/support/action/login";

require('dotenv').config();
const fs = require('fs');
const wdioHelper = require('./src/support/wdioHelper');
...
if (process.env.NODE_ENV === 'QA') {
    ...
    baseUrl = process.env.QA_OMS;
}
const debug = !!process.env.DEBUG;
const execArgv = debug ? ['--inspect'] : [];
const stepTimout = debug ? 24 * 60 * 60 * 1000 : 50000000;
...
exports.config = {
        ...
        [
            slack,
            {
                webhook:
                    ...
                    'https://hooks.slack.com/services/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',
    ...
    reporters: [
        ...
        //     slackBotToken:"xoxb-4568907985-1299572605873-MJ7BAjASFlKuDewTLF06BCr4",
        //     channel:"C018DKL11MK",
    ...
    onPrepare: function(config, capabilities) {
        try {
            ...
            del(['allure-results/**', 'reports/json/tmp/**.json']);
            ...
            console.log('*********************');
            console.log('Directries Delete');
            console.log('*********************');
        } catch (e) {
            console.log('*********************');
            console.log('Directries Already And Created');
            console.log('*********************');
        }
    },
    /**
    ...
    beforeFeature: function(uri, feature, scenarios) {
        ...
        try {
            ...
            wdioHelper.KeyHome();
            console.log('**********************');
            console.log('Before Feature TRY');
            console.log('**********************');
        } catch (e) {
            e.message();
        }
    ...
    onComplete: function(exitCode, config, capabilities, results) {
        try {
            ...
            var options = {
                name: 'Cuddle Clone Report',
                theme: 'bootstrap',
                jsonFile: jsonFile,
                // output: `reports/html/report-${currentTime}.html`,
                output: `reports/html/report-CC.html`,
